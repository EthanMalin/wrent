...
fn main() {
	...
	let c: [Vec2<i32>; 3] = [Vec2::new(600, 500), Vec2::new(500, 600), Vec2::new(400, 500)];

	draw::triangle_wireframe(&a[0], &a[1], &a[2], &mut image, [255, 255, 255]);
	draw::triangle_wireframe(&b[0], &b[1], &b[2], &mut image, [255, 255, 255]);
	draw::triangle_wireframe(&c[0], &c[1], &c[2], &mut image, [255, 255, 255]);
